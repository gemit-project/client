...
export default function BasicFilter() {
  ...
  const style6 = {
    ...
    marginLeft: "2vw",
    marginTop: moreColor ? "1vh" : "2vh",
    height: "23px",
    width: moreColor ? "4.2vw" : "4vw",
  };
  ...
  const arr = [1, 2, 3, 4, 5];
  const f: any = IconsArr.map((i) => {
    return { ...i, checked: false };
  });
  const [currentShapes, setCurrentShapes] = useState(f);
  ////f2
  const f2: any = MoreIconsArr.map((i) => {
    return { ...i, checked: false };
  });
  ...
  const h = () => {
    setMore(!more);
    if (!more) setHeightShape("52vh");
    else setHeightShape("28vh");
  };
  const h2 = () => {
    setMoreColor(!moreColor);
    if (!moreColor) setHeightShape2("36vh");
          ...
          <div className="block1Input">
            ...
            >
              ...
              <div>
                ...
                {more
                  ? f2.map((element: IconCol, i: number) => (
                      <Button
                        variant="contained"
                        size="small"
                        style={{
              ...
              <div>
                <button
                  ...
                  className="wrapArrowButtons"
                >
                  {more ? (
                    <button className="upButton1">▲</button>
                  ) : (
                    <button className="downButton1">▼</button>
                  )}
                </button>
              </div>
            </div>
            <div style={{ marginTop: "7vh", marginLeft: "6vw" }}>
              <br />
              <b>Carat (size)</b>
              <br />
              <br />
              ...
              >
                ...
                {arr.map((element: number) => (
                  <MenuItem value={element} style={style2}>
                    {element}
                  </MenuItem>
                ))}
              </Select>
          ...
          <div className="block12">
            ...
            <div className="color" style={{ height: heightShape2 }}>
              ...
              {ABCArr.map((element: string) => (
                <Button variant="contained" size="small" style={style6}>
                  {element}
                </Button>
              ))}
              {moreColor
                ? ABCArrMore.map((element: string) => (
                    <Button variant="contained" size="small" style={style6}>
                      {element}
                    </Button>
                  ))
              ...
              >
                {moreColor ? (
                  <button className="upButton2">▲</button>
                ) : (
                  <button className="dropButton2">▼</button>
                )}
              </button>
            </div>
            <br />
