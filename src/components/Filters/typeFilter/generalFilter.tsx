...
export default function GeneralFilter() {
    ...
    const style1 = { backgroundColor: '#EDFAFF', display: 'flex', height: '15vh', marginLeft: 'auto', marginRight: 'auto', width: '78vw', marginTop: '3vh' }
    const style2 = { width: '12vw', height: '30px' }
    const style3 = { backgroundColor: '#00B2FF', borderBlockEnd: '1px solid white' }
    ...
    return (
        <>
            <Card style={style1}>
                <div className='' style={{ borderRight: '1px solid gray', width: '26vw' }}>
                ...
                <div style={{ marginLeft: '0.5vw', borderRight: '1px solid gray', width: '26vw' }}>
                    <b></b><br />
            ...
            <div className='switch'>
                ...
                <div style={{ margin: 'auto' }}>
                    <Switch onChange={() => { setChecked(!checked) }} checked={checked}
                        offHandleColor='#fff' onHandleColor='#fff' width={200} 
                        onColor='#afb4b7' offColor="#00B2FF"
                        checkedIcon={<p className='pchecked'>Natural</p>} uncheckedIcon={<p className='punchecked'>Lab</p>} />
                </div>
            </div>
            <div className='inputs'><br />
                <div style={{ marginLeft: '5vw' }}><b>Period</b><br />
                    <Select
                        value={num1}
                        ...
                        {arr.map((element: number) =>
                            <MenuItem value={element} style={style3}>{element}</MenuItem>
                        )}
                    </Select>
                </div>
