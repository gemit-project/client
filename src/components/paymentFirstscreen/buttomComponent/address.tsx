...
<div style={{width:' 672wv', flexDirection: 'column', gap: 10, display: 'inline-flex'}}>
  <div style={{width: 408,height: 350, color: '#030406', textAlign:'left', fontSize: 24, fontFamily: 'Poppins', fontWeight: '600', textTransform: 'uppercase', lineHeight: 28.80, wordWrap: 'break-word'}}>Address</div>

  
  <div style={{width: '840%', height: '90h%', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 24, display: 'inline-flex'}}>
  ...
  <div style={{width: '654wv', height: '0hv', opacity: 0.65, border: '1px #030406 solid'}}></div>
</div>
