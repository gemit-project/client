...
import { InputAdornment, IconButton, createTheme, Select, MenuItem } from '@mui/material';
          ...
          >
            ...
            <Box component="form"   sx={{ mt: 1 }}>
              ...
              <TextField
                ...
                label="first Name"
                name="firstName"
                onChange={(e) => { setUser({...user, firstName : e.target.value });setvalids([...valids,valids[2]=true])
              }}
              />
              <TextField
                margin="normal"
                ...
                onChange={(e) => { setUser({...user, lastName : e.target.value });setvalids([...valids,valids[3]=true])}}
              />
              <TextField
                margin="normal"
                required
              ...
              onBlur={(e:any)=>{ setUser({...user,protectedData:{phoneNumber:e.currentTarget.value.replaceAll(" ","-")}}) }} />
              <TextField
                margin="normal"
                fullWidth
                id="age"
              ...
              />
              <input name='ch' id='ch' type='checkbox' onChange={(e)=>{isValid(e)}}/> I agree to the Terms of Use
              <Button
                type="submit"
                fullWidth
                variant="contained"
              ...
              <button
              onClick={handleSubmit}>fffff</button>
            </Box>
          </Box>
        </Container>
      </ThemeProvider>
